...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Values live in app/globals.css under [data-theme='...'] blocks —
        // see ThemePicker/ThemeContext for how the active theme is chosen.
        stage: {
          ...
          // Text color for content sitting on top of a bg-stage-accent
          // surface (buttons, active tabs, chat bubbles). Kept separate
          // from stage.bg because in the Light theme the page background
          // is light but on-accent text still needs to be dark/white.
